...
namespace Usuarios_planta
{
    public partial class desembolso : Form
    {
        ...
        public desembolso()
        {
            ...
            this.DoubleBuffered = true; // activar el buffer para reducir el parpadeo en los graficos del formulario
        ...
        {
            AbrirFormHijo(new FrmAsignacion());
        }

        private void Btncheques_Click(object sender, EventArgs e)
        {
            AbrirFormHijo(new FrmCheques());
        }
        bool move = false;
